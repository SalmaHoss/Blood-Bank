...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('clients', function(Blueprint $table) {
			$table->foreign('client_post_id')->references('id')->on('client_post')
						->onDelete('restrict')
						->onUpdate('restrict');
		});
		Schema::table('clients', function(Blueprint $table) {
		...
		Schema::table('clients', function(Blueprint $table) {
			$table->foreign('client_notifications_id')->references('id')->on('client_notifications')
						->onDelete('restrict')
						->onUpdate('restrict');
		});
	...
	public function down()
	{
		...
		Schema::table('clients', function(Blueprint $table) {
			$table->dropForeign('clients_client_post_id_foreign');
		});
		Schema::table('clients', function(Blueprint $table) {
			$table->dropForeign('clients_blood_type_id_foreign');
		});
		Schema::table('clients', function(Blueprint $table) {
			$table->dropForeign('clients_client_notifications_id_foreign');
		});
		Schema::table('cities', function(Blueprint $table) {
